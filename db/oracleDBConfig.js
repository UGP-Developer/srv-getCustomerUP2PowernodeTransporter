...
module.exports = {
	...
	// needed.
	password: process.env.NODE_ORACLEDB_PASSWORD || "apps",

	// For information on connection strings see:
	// https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
	connectString: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "172.30.221.85:1521/prod",
	// connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "192.168.25.83:1521/dbr12",
